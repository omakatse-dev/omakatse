  ...
  return (
    <div className="mt-28 sm:mt-48 px-6 pb-10 sm:pb-20 w-screen max-w-4xl">
      ...
      <div className="bodyMD text-gray-800 mt-1 text-center">
        Give everything a quick check before renewing! Want to change the box
        size, plan, or pet? Just hit{" "}
        <span className="font-bold">Edit Subscription</span> to make updates.
      </div>
