  ...
  return (
    <div className="mx-auto max-w-screen-2xl justify-items-center">
      <div className="flex w-full flex-col-reverse px-6 py-5 text-center xl:flex-row xl:px-18">
        <div className="w-full xl:w-1/2 xl:pt-12 xl:pb-12 xl:pl-12 xl:text-left">
      ...
      <div className="flex w-full flex-col px-6 pb-10 text-center md:px-12 xl:flex-row xl:px-18 xl:pb-20">
        <div className="flex w-full justify-center xl:w-1/2">
          <Image
            ...
            width={600}
            height={200}
            className="xl:auto w-full xl:h-auto"
          />
        </div>
