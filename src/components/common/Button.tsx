...
export default function Button({ buttonContent, variant="primary", onClick }: ButtonProps) {
    return (
        <div>
            <button onClick={onClick} className={`flex justify-center align-middle py-2.5 sm:py-4 px-10 outline-1 bodyButton rounded-full text-black bg-white outline-black transition-all cursor-pointer
                ${variant === "primary" ? 
